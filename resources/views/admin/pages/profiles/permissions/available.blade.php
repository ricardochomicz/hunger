...
<div class="card">
    <div class="card-header">
        <form action="{{route('profiles.permissions.available', $profile->id)}}" class="form-inline float-left" method="POST">
            @csrf
            ...
            <tbody>
                ...
                <tr>
                    <td class="align-middle">
                        <input type="checkbox" name="permissions[]" id="customCheckbox1" value="{{$permission->id}}">
                    </td>
