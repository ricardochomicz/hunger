...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{route('permissions.create')}}" class="btn btn-sm btn-dark float-right"><i class="fas fa-plus mr-1"></i> Novo</a>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                        <a href="{{route('permissions.show', $permission->id)}}" class="btn btn-primary btn-sm">Ver</a>
